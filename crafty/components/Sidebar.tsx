...
import { Code2, FileVideo2, ImageIcon, LayoutDashboard, MessageCircle, Music2, Settings, } from 'lucide-react'
        ...
        <div className='space-y-4 py-4 flex flex-col h-full bg-black text-white'>
            <div className='px-3 py-2 flex-1'>
                ...
                <div className='space-y-1'>
                    {routes.map((route) => (
                        <Link href={route.href} key={route.href} className='text-sm group flex p-3 w-full
            ...
            <div className='px-3 py-2'>
                <Link href="/settings" className='text-sm group flex p-3 w-full mt-56
                justify-start font-medium cursor-pointer hover:text-white hover:bg-white/10
                rounded-lg transition'>
                    <div className='flex items-center flex-1 '>
